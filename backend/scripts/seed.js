...
const insertBooking = db.prepare(`
  INSERT INTO bookings (id, user_id, username, type, item_id, travelers, status, created_at)
  VALUES (@id, @user_id, @username, @type, @item_id, @travelers, @status, @created_at)
`);

const bookings = [
  {
    "id": "booking-ab65db8d-318c-40d3-af0b-ee430a0aeb4d",
    "user_id": "wayfinder-ayeha",
    "username": "wayfinder-ayeha",
    "type": "flight",
    "item_id": "flight-cmb-dxb-01",
    "travelers": 1,
    "status": "confirmed",
    "created_at": "2026-06-08T12:55:25.378Z"
  }
];
